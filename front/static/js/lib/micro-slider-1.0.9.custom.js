  ...
  var MicroSlider = function () {
    function MicroSlider(container) {
      ...
      this.setActiveItem = function (el) {
        ...
        for(var i = 0; i < _this.items.length; i++) {
          _this.items[i].setAttribute('aria-hidden', true);
        }
      ...
      this.setActiveIndicator = function () {
        if (_this.options.indicators && _this.activeIndicator !== _this.indicators[_this.activeItemIndex]) {
          ...
          // s: custom
          _this.activeIndicator.children[0].removeAttribute('aria-selected');
          // e: custom
          ...
          // s: custom
          _this.activeIndicator.children[0].setAttribute('aria-selected', true);
          // e: custom
        }
      };
      ...
      this.renderTranslation = function (el, zIndex, opacity, x1, z) {
        ...
        if (!_this.options.fullWidth) {
          ...
          // s: custom
          var tX = (_this.sliderWrapper.clientWidth - _this.itemDimensions.width) / 2;
          var tY = (_this.sliderWrapper.clientHeight - _this.itemDimensions.height) / 2;
          // e: custom
    ...
    _createClass(MicroSlider, [{
      ...
      value: function setSliderPerspective() {
        ...
        // s: custom
        const $setHeight = Math.max(this.sliderContainer.offsetHeight, this.itemDimensions.height)
        this.sliderWrapper.style.height = $setHeight + 'px'; 
        // e: custom
      ...
      value: function setIndicators() {
        ...
        if (this.options.indicators) {
          ...
          var _loop = function _loop(i) {
            ...
            // s: custom
            indicator.innerHTML = '<a href="#" role="button">'+(i+1)+'번 '+ _this2.options.indicatorText + '</a>';
            // e: custom
            ...
            if (i === 0) {
              ...
              // s: custom
              indicator.children[0].setAttribute('aria-selected', true);
              // e: custom
            }
      ...
      value: function bindEvents() {
        ...
        if (typeof window.ontouchstart !== 'undefined') {
          ...
          */
          // s: custom
          this.sliderWrapper[fn]('touchstart', this.tapHandler);
          this.sliderWrapper[fn]('touchmove', this.dragHandler);
          this.sliderWrapper[fn]('touchend', this.releaseHandler);
          // e: custom
        }
        ...
        */
        // s: custom
        this.sliderWrapper[fn]('mousedown', this.tapHandler);
        this.sliderWrapper[fn]('mousemove', this.dragHandler);
        this.sliderWrapper[fn]('mouseup', this.releaseHandler);
        this.sliderWrapper[fn]('mouseleave', this.releaseHandler);
        this.sliderWrapper[fn]('click', this.clickHandler);
        // e: custom
